...
function sanitizeProfile(profile) {
  ...
  return {
    ...
    job_status: profile.jobStatus ?? null,
    job_status_other: profile.jobStatusOther ?? "",
...
app.put("/api/onboarding-profile", ...requireSessionWithCsrf, async (req, res) => {
  ...
  const next = await prisma.userOnboardingProfile.upsert({
    ...
    update: {
      ...
      jobStatus: body.job_status == null ? null : typeof body.job_status === "string" ? body.job_status : null,
      jobStatusOther: body.job_status_other == null ? null : typeof body.job_status_other === "string" ? body.job_status_other : null,
