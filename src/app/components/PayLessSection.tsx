  ...
  return (
    <section className="py-10 bg-white">
      <div className="container mx-auto max-w-7xl px-5">
        ...
        {/* One large outer card — matches PersonalManager card composition */}
        <div
        ...
        >
          <div className="grid md:grid-cols-[45%_55%] min-h-[520px]">

            {/* LEFT: Bank UI mockup */}
            <div className="flex items-end justify-center px-10 pt-10 pb-12 md:px-12 md:pt-0 md:pb-12">
              <div
            ...
            {/* RIGHT: Copy — vertically centered inside the card */}
            <div className="flex items-center px-8 py-12 md:px-12 md:py-16">
