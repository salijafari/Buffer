        ...
        <div className="bg-gradient-to-br from-[#e2eff5] to-[#dbe9ff] rounded-3xl p-8 md:p-16">
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-col items-center gap-4">
              <img src={imgQR} alt="QR Code" className="w-40 h-40" />
              <img src={imgAppStore} alt="Download badges" className="h-3" />
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <button className="bg-[#081419] text-white px-6 py-3 rounded-lg hover:bg-gray-800 transition inline-flex items-center justify-center gap-2">
